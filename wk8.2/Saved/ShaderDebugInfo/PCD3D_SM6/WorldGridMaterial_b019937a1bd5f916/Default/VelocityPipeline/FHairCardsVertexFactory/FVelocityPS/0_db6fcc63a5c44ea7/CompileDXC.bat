...
%DXC% -HV 2018 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T ps_6_6 -E MainPixelShader__OPTIMIZED -Fc VelocityShader.d3dasm -Fo VelocityShader.dxil VelocityShader.usf
:END
PAUSE
